package com.icarexm.jiedi.custView;
...
public class KeepCountdownView extends View {
    ...
    public static final float RADIUS_IN_DP = 60;
    ...
    public KeepCountdownView(Context context, AttributeSet attrs, int defStyle) {
        ...
        contentTextSize = ta.getDimension(R.styleable.KeepCountdownView_contentTextSize,
                sp2px(NUM_TEXT_SIZE_IN_SP));
...
//        arcPaint.setStrokeCap(Paint.Cap.ROUND); //圆角
        ...
        contentPaint.setColor(numColor);
